...
- **テストルールの遵守**: `docs/testing-rules.md` に定義されたルールに従ってテストを評価する
...
テストルールは `docs/testing-rules.md` を参照すること。
レビュー前に必ずReadツールでこのファイルを読み込み、ルールに従って評価する。

## レビューワークフロー

1. **テストルールの確認**: `docs/testing-rules.md` を読み込み、現在のルールを理解する
